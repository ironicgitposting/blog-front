...
* [`src/blog/`](src/blog/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/blog/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `blog` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/blog/config.cljs) defaults to `true` in
